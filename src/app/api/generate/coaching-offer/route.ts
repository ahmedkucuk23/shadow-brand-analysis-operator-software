...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const prompt = `You are an expert coaching program designer. Generate a comprehensive Coaching Offer document that transforms the selected UVZ into a complete, structured coaching program with detailed action plans, worksheets, and module outlines.
